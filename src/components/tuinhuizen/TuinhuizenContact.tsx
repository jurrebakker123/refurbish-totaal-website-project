      ...
      <div className="container">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12 text-brand-darkGreen">
            Direct Contact met Onze Tuinhuis Specialisten
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
            <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow text-center">
              ...
              <p className="text-gray-600 mb-6">
                Spreek direct met een tuinhuis specialist voor persoonlijk advies.
              </p>
              <Button 
          ...
          <div className="mt-12">
            <ReusableForm 
              title="Vraag direct een offerte aan voor uw tuinhuis"
              description="Ontvang binnen 24 uur een reactie van onze tuinhuis specialisten."
              showFileUpload={true}
