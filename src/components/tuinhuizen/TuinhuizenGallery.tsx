...
const ANGLES = [{
  degree: 0,
  src: '/lovable-uploads/a6112a45-bfd2-4d20-b496-8dc7a87d8142.png'
}, {
  degree: 45,
  src: '/lovable-uploads/d67ca9bb-8389-42de-a068-52cf63d8b04a.png'
}, {
  degree: 90,
  src: '/lovable-uploads/2436d289-2c67-4857-89ad-61736ba3dc09.png'
}, {
  degree: 135,
  src: '/lovable-uploads/f73444a4-98da-45bd-b6aa-7cd2faa43809.png'
}, {
  degree: 180,
  src: '/lovable-uploads/1d399cd4-9b33-4b0d-8c07-f6314f8b5a6a.png'
}, {
  degree: 225,
  src: '/lovable-uploads/3fb04066-dfc7-400c-9fda-28e2a97979a4.png'
}, {
  degree: 270,
  src: '/lovable-uploads/0e7822c5-5fb3-4431-868f-04b3c7ca0be1.png'
}, {
  degree: 315,
  src: '/lovable-uploads/0271be36-660a-4b52-bf9a-b9d16efce0c5.png'
}];
  ...
  return <section className="py-16 bg-gradient-to-b from-gray-50 to-white">
      <div className="container">
        <div className="text-center mb-10">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-brand-darkGreen">Plano Tuinhuis – 500 cm breed</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          <div className="bg-white rounded-xl shadow-lg overflow-hidden">
            <AspectRatio ratio={16 / 10} className="bg-sky-50">
              <div ref={containerRef} className="w-full h-full relative cursor-grab active:cursor-grabbing" onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp} onTouchStart={handleTouchStart} onTouchMove={handleTouchMove} onTouchEnd={handleTouchEnd}>
                <div className="w-full h-full flex items-center justify-center">
                  ...
                  {/* Loading indicator */}
                  {!imageLoaded && <div className="absolute inset-0 flex items-center justify-center bg-gray-100 bg-opacity-80">
                      <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-brand-darkGreen"></div>
                    </div>}
                  
                  {/* Current angle image */}
                  <img src={currentImage.src} alt={`Tuinhuis vanuit ${currentImage.degree}°`} className="w-full h-full object-cover" style={{
            ...
            <div className="px-6 py-4 bg-white border-t border-gray-100">
              ...
              <Slider value={[sliderValue]} min={0} max={359} step={1} onValueChange={handleSliderChange} className="py-2" />
            </div>
            
            <div className="p-4 bg-gray-50 border-t">
              <div className="flex justify-between items-center">
                <button onClick={() => setAutoRotate(!autoRotate)} className="text-sm px-3 py-1 rounded bg-gray-200 hover:bg-gray-300 transition-colors flex items-center gap-1">
                  {autoRotate ? <>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <Carousel className="w-full max-w-md">
                <CarouselContent>
                  {['/lovable-uploads/a6112a45-bfd2-4d20-b496-8dc7a87d8142.png', '/lovable-uploads/d67ca9bb-8389-42de-a068-52cf63d8b04a.png', '/lovable-uploads/2436d289-2c67-4857-89ad-61736ba3dc09.png', '/lovable-uploads/f73444a4-98da-45bd-b6aa-7cd2faa43809.png', '/lovable-uploads/1d399cd4-9b33-4b0d-8c07-f6314f8b5a6a.png', '/lovable-uploads/3fb04066-dfc7-400c-9fda-28e2a97979a4.png', '/lovable-uploads/0271be36-660a-4b52-bf9a-b9d16efce0c5.png', '/lovable-uploads/0e7822c5-5fb3-4431-868f-04b3c7ca0be1.png'].map((src, index) => <CarouselItem key={index}>
                      <div className="p-1">
                        <div className="overflow-hidden rounded-lg shadow-md">
                          <img src={src} alt={`Tuinhuis impressie ${index + 1}`} className="w-full h-full aspect-square object-cover object-center" />
                        </div>
                      </div>
                    </CarouselItem>)}
                </CarouselContent>
            ...
            <div className="pt-4">
              <a href="#offerte-aanvragen" className="btn-primary inline-flex items-center gap-2 px-8 py-3 rounded-md">
