...
const ChatBot = () => {
  ...
  return (
    <>
      ...
      <motion.button
        onClick={() => setIsOpen(true)}
        className={`fixed bottom-6 right-6 w-16 h-16 rounded-full bg-brand-darkGreen text-white flex items-center justify-center shadow-lg z-50 ${
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            className="fixed bottom-6 right-6 w-[350px] sm:w-[380px] h-[500px] bg-white rounded-lg shadow-xl flex flex-col z-50"
