...
const services = [
  {
    id: 'schilderwerk',
    icon: <Brush className="h-12 w-12 text-brand-orange mb-4" />,
    title: 'Schilderwerk',
  ...
  {
    id: 'dakrenovatie',
    icon: <Home className="h-12 w-12 text-brand-orange mb-4" />,
    title: 'Dakrenovatie',
  ...
  {
    id: 'stucadoren',
    icon: <Construction className="h-12 w-12 text-brand-orange mb-4" />,
    title: 'Stucadoren',
  ...
  },
  {
    ...
    icon: <Wrench className="h-12 w-12 text-brand-orange mb-4" />,
  ...
  {
    id: 'pvc-vloeren',
    icon: <SquareGanttChart className="h-12 w-12 text-brand-orange mb-4" />,
    title: 'PVC Vloeren',
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <div
              key={service.id} 
              className="bg-white p-8 rounded-lg shadow-md hover:shadow-lg transition-shadow flex flex-col h-full"
            >
              ...
              <Link 
                to={service.link} 
                className="text-brand-orange font-medium hover:underline inline-flex items-center"
              >
                Meer Informatie
