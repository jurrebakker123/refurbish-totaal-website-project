      ...
      <div className="container">
        ...
        delay: 0.3
          ...
          <div className="bg-gray-50 p-8 rounded-lg max-w-2xl text-center">
            ...
            <a href="https://g.page/r/CaugvSM-hsKnEAI/review" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 bg-white border border-gray-300 px-6 py-3 rounded-lg text-gray-700 font-medium hover:bg-gray-100 transition-colors shadow-sm">
