...
console.log("=== HANDLE-DAKKAPEL-CALCULATOR-REQUEST FUNCTION STARTED ===");
...
const handler = async (req: Request): Promise<Response> => {
  console.log("=== NEW DAKKAPEL CALCULATOR REQUEST TRIGGER ===");
  ...
  try {
    console.log("Processing new dakkapel calculator request trigger...");
    ...
    console.log("New dakkapel calculator entry:", { id: newRecord.id, email: newRecord.emailadres });
    ...
    console.error("=== CRITICAL ERROR IN DAKKAPEL CALCULATOR TRIGGER ===", error);
    return new Response(
      JSON.stringify({ 
        success: false, 
